...
def test_ingredient_parser(arg, u1_s1):
    expectations = {
        ...
        "砂糖 50g": (50, "g", "砂糖", ""),
        "卵 4個": (4, "個", "卵", ""),
        "豚ロース肉（薄切り） … 200ｇ（10枚ほど）": (200, "g", "豚ロース肉(薄切り)", "10枚ほど"),
        "生姜　…　30g（下記工程写真も参考に）": (30, "g", "生姜", "下記工程写真も参考に"),
        "玉ねぎ　…　1/4個": (0.25, "個", "玉ねぎ", ""),
        "キャベツのせん切り　…　適量": (0, None, "キャベツのせん切り", "適量"),
        "サラダ油や米油など好みの油　…　大さじ1": (1, "大さじ", "サラダ油や米油など好みの油", ""),
        "ごま油　…　小さじ1/2": (0.5, "小さじ", "ごま油", ""),
        "醤油　…　大さじ1と1/2": (1.5, "大さじ", "醤油", ""),
        "酒　…　大さじ1": (1, "大さじ", "酒", ""),
        "みりん　…　大さじ1/2": (0.5, "大さじ", "みりん", ""),
        "ケチャップ　…　小さじ1/2": (0.5, "小さじ", "ケチャップ", ""),
